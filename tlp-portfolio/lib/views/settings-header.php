    ...
    <div class="settings-container">
        <div class="rt-settings-header-inner">
            <div class="settings-logo">
                <div class="rt-logo">
                    <img src="<?php echo  esc_url( TLPPortfolio()->assetsUrl . 'images/portfolio-gif.gif' ); ?>" width="74px"
                         height="74px" alt="Tlp Team">
                </div>
                <div class="rt-content">
                    <h2><?php esc_html_e( 'Portfolio', 'tlp-portfolio' ); ?></h2>
            ...
            <div class="settings-menu">
                <a href="<?php echo esc_url( rt_settings_url() ); ?>">
                    ...
                    <?php esc_html_e( 'Settings', 'tlp-portfolio' ); ?>
                </a>
                <a href="https://www.radiustheme.com/ticket-support/" target="_blank">
                    ...
                    <?php esc_html_e( 'Support', 'tlp-portfolio' ); ?>
                </a>
                <a href="<?php echo esc_url( rt_settings_url( 'tlp_portfolio_get_help' ) ); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g>
                    ...
                    <?php esc_html_e( 'Help', 'tlp-portfolio' ); ?>
                </a>
                <a class="doc" href="<?php echo esc_url( '//radiustheme.com/how-to-setup-and-configure-tlp-portfolio-free-version-for-wordpress/' ); ?>" target="_blank">
                    ...
                    <?php esc_html_e( 'Documentation', 'tlp-portfolio' ); ?>
                </a>
            </div>
        </div>
    </div>
